...
class GLWindow(QGLWidget):
    ...
    def initializeGL(self):
        ...
        _shaders = self.loadShaders('5.parallax_mapping.vs', '5.parallax_mapping.frag')
        ...
        # load texture
        self.diffuseMap = loadTexture(os.path.join(abPath, '..', '..', 'resources', 'textures', 'bricks2.jpg'))
        self.normalMap = loadTexture(os.path.join(abPath, '..', '..', 'resources', 'textures', 'bricks2_normal.jpg'))
        self.heightMap = loadTexture(os.path.join(abPath, '..', '..', 'resources', 'textures', 'bricks2_disp.jpg'))
        # self.diffuseMap = loadTexture(os.path.join(abPath, '..', '..', 'resources', 'textures', 'wood.png'))
        # self.normalMap = loadTexture(os.path.join(abPath, '..', '..', 'resources', 'textures', 'toy_box_normal.png'))
        # self.heightMap = loadTexture(os.path.join(abPath, '..', '..', 'resources', 'textures', 'toy_box_disp.png'))
    ...
    def paintGL(self):
        ...
        glUniform1f(glGetUniformLocation(self.__shader, 'height_scale'), self.height_scale)
        glUniform1i(glGetUniformLocation(self.__shader, 'parallax'), self.parallax_mapping)
    ...
    def keyPressEvent(self, event):
        ...
        if event.key() == Qt.Key_Space:
            self.parallax_mapping = not self.parallax_mapping
        if event.key() == Qt.Key_Q:
            self.height_scale -= 0.05 * self.__deltaTime
