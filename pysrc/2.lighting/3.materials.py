...
class GLWindow(QGLWidget):
    ...
    def initializeGL(self):
        ...
        self.__lightingShader = self.loadShaders("3.materials.vs", "3.materials.frag")
    ...
    def paintGL(self):
        ...
        lightColor = np.array([math.sin(self.__timer.elapsed() / 1000.0),
                               math.sin(self.__timer.elapsed() / 1000.0),
                               math.sin(self.__timer.elapsed() / 1000.0)],
                              np.float32)
        diffuseColor = .5 * lightColor
        ambientColor = .2 * diffuseColor
        ...
        glUniform3f(glGetUniformLocation(self.__lightingShader, 'material.ambient'),
                    1.0, 0.5, 0.31)
        glUniform3f(glGetUniformLocation(self.__lightingShader, 'material.diffuse'),
                    1.0, 0.5, 0.31)
        glUniform3f(glGetUniformLocation(self.__lightingShader, 'material.specular'),
                    0.5, 0.5, 0.5)
