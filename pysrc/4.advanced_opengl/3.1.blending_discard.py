...
class GLWindow(QGLWidget):
    ...
    def loadShaders(self):
        vertexShaderFile = os.path.join(abPath, '3.1.blending_discard.vs')
        fragmentShaderFile = os.path.join(abPath, '3.1.blending_discard.frag')
        vertexShaderSource = ''
    ...
    def initializeGL(self):
        ...
        texture3Path = os.path.join(abPath, '..', '..', 'resources', 'textures', 'grass.png')
